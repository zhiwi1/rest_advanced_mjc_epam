...
//                given()
//                        .auth().oauth2(token)
//                        .when().get("http://localhost:8001/v3/orders/1");
...
//                given()
//                        .auth().oauth2(token)
//                        .when().get("http://localhost:8001/v3/orders/users/10");
...
//                given()
//                        .auth().oauth2(token)
//                        .when().get("http://localhost:8001/v3/orders/users/2");
//        Assertions.assertEquals(200, response.getStatusCode());
//    }
//
//    @Test
...
//                given()
//                        .auth().oauth2(token)
//                        .when().get("http://localhost:8001/v3/users/1");
//        Assertions.assertEquals(403,response.getStatusCode());
//    }
//
//}
